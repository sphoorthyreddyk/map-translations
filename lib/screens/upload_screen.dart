// ignore_for_file: non_constant_identifier_names, empty_statements
...
import 'package:firebase_signin/screens/show_image.dart';
import 'package:uuid/uuid.dart';

import 'package:firebase_signin/auth_methods.dart';
import 'package:firebase_signin/input.dart';
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        children: [
                          CircleAvatar(
                            backgroundColor: const Color.fromARGB(255, 64, 14, 50),
                            radius: 40,
                            child: IconButton(
                                onPressed: () async {
                      ...
                      Column(
                        children: [
                          CircleAvatar(
                            backgroundColor: const Color.fromARGB(255, 48, 30, 103),
                            radius: 40,
                            child: IconButton(
                                onPressed: () async {
                                  //     // Navigator.of(context).pop();
